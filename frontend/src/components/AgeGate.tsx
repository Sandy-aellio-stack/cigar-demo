...
const AgeGate = ({ onVerified }: Props) => {
  ...
  return (
    <div className="fixed inset-0 bg-black text-white flex items-center justify-center z-50">
      <div className="max-w-md w-full p-8 border border-gold/30 bg-neutral-900 rounded-lg text-center">
        <h1 className="text-2xl font-semibold mb-2">Age Verification</h1>
        ...
        <div className="flex gap-2 mb-4">
          <input
            ...
            max={12}
            min={1}
            className="w-1/3 p-3 bg-black border border-gray-700 rounded text-center"
